...
import { Provider, useSelector, useDispatch } from "react-redux"; // Importing Provider, useSelector, and useDispatch from Redux
...
const App = () => {
  ...
  return (
    <Router> {/* The Router component enables routing in our app */}
      <Navbar /> {/* Render the Navbar component at the top of every page */}
